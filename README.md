...
The `HPC_scripts` directory contains scripts and workflows optimized for the UGent HPC environment, while the `WSL2_scripts` directory contains scripts compatible with the local WSL2 environment.
